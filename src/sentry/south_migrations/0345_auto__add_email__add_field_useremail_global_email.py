...
class Migration(SchemaMigration):
        ...
        db.create_table(
            'sentry_email', (
                (
                    ...
                    'email',
                    self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)
                ),
            )
        )
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': (
                'django.db.models.fields.CharField', [], {
                    'default': "'37f8ff11eaa049d2a7da0a9f06b88156952a0fafad5349e08811e0f84a0e5e8e'",
                    'unique': 'True',
                    'max_length': '64'
                }
            ),
            'client_secret': (
                'sentry.db.models.fields.encrypted.EncryptedTextField', [], {
                    'default': "'5efcf77f6a4c4d1ca58f91cab6287773b5eb91339cd548fc862de35b81a99a69'"
                }
            ),
            'date_added':
            ('django.db.models.fields.DateTimeField', [], {
        ...
        'sentry.apigrant': {
            ...
            'code': (
                'django.db.models.fields.CharField', [], {
                    'default': "'fe5b1fd269f0443b8b2ead5187a4ba7d'",
                    'max_length': '64',
                    'db_index': 'True'
                }
            ),
        ...
        'sentry.apitoken': {
            ...
            'refresh_token': (
                'django.db.models.fields.CharField', [], {
                    'default': "'918d48774e724c779ea8f4f2d5d5e898566177aa76074c358b7e181370358353'",
                    'max_length': '64',
                    'unique': 'True',
                    'null': 'True'
                }
            ...
            'token': (
                'django.db.models.fields.CharField', [], {
                    'default': "'39d5f2bf35cb4020bf55a2c83fb982d34bcafb9f10994351bcb2cce0473fc9f9'",
                    'unique': 'True',
                    'max_length': '64'
                }
            ),
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': (
                'django.db.models.fields.CharField', [], {
                    'default': "'d846f8b2cb134100a426801f14d8ed67'",
                    'unique': 'True',
                    'max_length': '32'
                }
            ),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': (
                'django.db.models.fields.CharField', [], {
                    'default': "u'NdplZuHdEYCdVfRzm2q1PiTtiWkRtzfM'",
                    'max_length': '32'
                }
            )
        },
